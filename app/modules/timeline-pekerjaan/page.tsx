  ...
  return (
    <div className="min-h-screen bg-gray-50/50 p-6 md:p-8 font-sans text-gray-800">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 tracking-tight">Timeline Pekerjaan</h1>
          <p className="text-gray-500 text-sm mt-1">Monitoring progres pekerjaan yang sedang berjalan (On Going).</p>
        </div>
        <button 
