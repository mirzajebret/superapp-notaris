                ...
                {formData.items.map((item, idx) => (
                    <div key={idx} className="relative bg-gray-50 p-3 rounded-lg border border-gray-200 group">
                        ...
                        <div className="space-y-2 pr-6">
                            <input type="text" placeholder="Deskripsi" className="w-full border border-gray-300 rounded p-1.5 text-sm font-medium" value={item.deskripsi} onChange={(e) => handleItemChange(idx, 'deskripsi', e.target.value)} />
        ...
        <div className="flex-1 w-full overflow-auto flex justify-center print:overflow-visible print:block print:w-full print:h-auto">
            ...
            <table className="w-full border-collapse border border-black text-[10pt] mb-2"> 
                ...
                {formData.items.map((item, idx) => (
                    ...
                    <td className="border border-black p-1 text-right align-top font-medium">Rp {item.biaya ? item.biaya.toLocaleString('id-ID') : '0'},-</td>
